...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # ✅ Send reminder with chat_id passed as arg
        def send_reminder(cid):
            logger.info(f"🔔 Sending reminder to chat {cid}")
